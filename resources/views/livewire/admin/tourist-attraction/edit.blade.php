                    ...
                    <div class="mt-8 space-y-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan judul objek wisata baru dengan singkat dan jelas
                                </p>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan deskripsi gambaran mengenai objek wisata yang dimaksud
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                <textarea 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan lokasi letak objek wisata dengan ringkas, misalkan "Rupat Utara, Bengkalis"
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                <input 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tandai lokasi yang tepat mengenai keberadaan objek wisata
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                <div 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                <label 
                                    for="travel-object-category-id"
                                    class="block mb-1 text-black font-medium capitalize"
                                >
                                    jenis objek wisata
                                </label>
                                <p class="text-sm text-true-gray-700">
                                    Tentukan jenis objek wisata berdasarkan pilihan yang ada
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                <select 
                                    wire:model="travelObjectCategoryId"
                                    id="travel-object-category-id"
                                    class="w-full rounded-lg border-black/75 focus:outline-none focus:ring focus:ring-black/20 focus:border-black"
                                >
                                    <option value=""></option>
                                    @foreach ($travelObjectCategories as $travelObjectCategory)
                                        <option value="{{ $travelObjectCategory->id }}">{{ $travelObjectCategory->category }}</option>
                                    @endforeach
                                </select>
                                @error('travelObjectCategoryId')
                                    <span class="block mt-2 text-xs text-red-600">
                                        {{ $message }}
                                    </span>
                                @enderror
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan gambar utama yang menarik untuk menggambarkan objek wisata
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                    ...
                                    @foreach ($oldGalleries as $j => $gallery)
                                        <div class="col-span-1">
                                            <div class="flex items-start space-x-2">
                                                <div class="relative w-full h-32 rounded-md overflow-hidden">
                                                    <img 
                                                        src="{{ asset('storage/images/galleries/travel-objects/' . $gallery['filename']) }}" 
                                                        class="w-full h-full object-cover"
                                                    >
                                                </div>
