    ...
    <div class="max-w-xl lg:max-w-screen-md mx-auto">
        <div class="text-center md:text-left mb-16 space-y-6">
            ...
            <p class="text-white/80 leading-7 text-base lg:text-lg">
                Anda dapat melakukan pengelolaan data-data objek wisata seperti menambahkan data objek wisata baru, mengubah data-data yang sudah ada ataupun menghapus data objek wisata yang sudah tidak relevan
            </p>
            <div class="flex items-center space-x-3">
                <a 
                    href="{{ route('admin.touristAttraction.create') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse ($touristAttractions as $touristAttraction)
                    <div class="col-span-1">
                        <a href="{{ route('admin.touristAttraction.details', $touristAttraction) }}">
                            <div class="relative w-72 mx-auto md:w-full h-80 rounded-xl overflow-hidden shadow-xl group">
                                ...
                                <div class="absolute w-full p-5 top-0 flex items-center justify-between">
                                    ...
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="{{ route('admin.touristAttraction.edit', $touristAttraction) }}" class="text-white hover:text-opacity-75">
                                                ...
                                                <div class="w-full h-full flex items-center justify-center">
                                                    <div class="w-[500px] px-8 pt-8 pb-12 md:px-10 md:pt-10 md:pb-14 bg-white rounded-lg whitespace-normal text-left">
                                                        <h1 class="text-true-gray-800 text-2xl leading-10">
                                                            Yakin ingin hapus data "{{ $touristAttraction->title }}"?
                                                        </h1>
                                                        <div class="mt-14 text-right space-x-2">
                                                            ...
                                                            <a 
                                                                href="#"
                                                                wire:click.prevent="delete({{ $touristAttraction }})"
