<div>
    <div class="w-full md:max-w-lg lg:max-w-screen-sm mx-auto">
                        ...
                        <div class="mt-8 relative">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    @foreach ($naturalCharm->galleries as $gallery)
                                        <div class="swiper-slide w-full h-80 md:h-96 lg:h-[500px] rounded-2xl overflow-hidden">
                                            <img 
                                                ...
                                                alt="{{ $naturalCharm->title . ' ' . $loop->iteration }}"
