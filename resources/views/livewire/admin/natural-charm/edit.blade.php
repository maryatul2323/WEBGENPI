                    ...
                    <div class="mt-8 space-y-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan judul pesona alam baru dengan singkat dan jelas
                                </p>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan deskripsi gambaran mengenai pesona alam yang dimaksud
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                <textarea 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan lokasi letak pesona alam dengan ringkas, misalkan "Rupat Utara, Bengkalis"
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                <input 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tandai lokasi yang tepat mengenai keberadaan pesona alam
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                <div 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan gambar utama yang menarik untuk menggambarkan pesona alam
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
