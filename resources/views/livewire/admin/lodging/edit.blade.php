                    ...
                    <div class="mt-8 space-y-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan judul penginapan baru dengan singkat dan jelas
                                </p>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan deskripsi gambaran mengenai penginapan yang dimaksud
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                <textarea 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan lokasi lengkap letak event yang akan diselenggarakan (nama jalan, kecamatan, kabupaten)
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                <textarea 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tandai lokasi yang tepat mengenai keberadaan penginapan
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                <div 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan harga penginapan mulai dari yang paling murah
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan gambar utama yang menarik untuk menggambarkan penginapan
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan beberapa gambar yang menggambarkan keistimewaan objek wisata
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                <div class="grid grid-cols-2 gap-4">
                                    @foreach ($oldGalleries as $j => $gallery)
                                        <div class="col-span-1">
                                            <div class="flex items-start space-x-2">
                                                <div class="relative w-full h-32 rounded-md overflow-hidden">
                                                    <img 
                                                ...
                                                <div class="space-y-2 flex-shrink-0">
                                                    <a 
                                                        href="#"
                                                        wire:click.prevent="deleteGelleryImage({{ $j }}, {{ $gallery['id'] }})"
                                                        class="inline-block {{ (count($galleries) + count($oldGalleries)) == 1 ? 'text-true-gray-400 cursor-default' : 'text-black hover:text-true-gray-700' }}"
                                                    >
                                ...
                                @if ((count($this->galleries) + count($this->oldGalleries)) < 6)
                                    <div class="mt-4">
                                        <a 
                                            href="#"
