                    ...
                    <div class="mt-8 space-y-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan judul event baru dengan singkat dan jelas
                                </p>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan deskripsi gambaran mengenai event yang dimaksud
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                <textarea 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tandai lokasi yang tepat mengenai keberadaan event
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                <div 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan tanggal pelaksanaan event
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
                                <div wire:ignore>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8">
                            <div class="col-span-1">
                                ...
                                <p class="text-sm text-true-gray-700">
                                    Tambahkan gambar utama yang menarik untuk menggambarkan event
                                </p>
                            </div>
                            <div class="col-span-1 pt-0 md:pt-4">
        ...
        document.addEventListener('livewire:load', function() {
            ...
            flatpickr(date, {
                ...
                locale: {
                    ...
                    months: {
                        shorhand: ['Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun', 'Jul', 'Agu', 'Sep', 'Okt', 'Nov', 'Des'],
