    ...
    <div class="max-w-xl lg:max-w-screen-md mx-auto">
        <div class="text-center md:text-left mb-16 space-y-6">
            ...
            <p class="text-white/80 leading-7 text-base lg:text-lg">
                Anda dapat melakukan pengelolaan data-data travel seperti menambahkan data travel baru, mengubah data-data yang sudah ada ataupun menghapus data travel yang sudah tidak relevan
            </p>
            <div class="flex items-center space-x-3">
                <a 
                    href="{{ route('admin.travel.create') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                @forelse ($travels as $travel)
                    <div class="col-span-1">
                        <a 
                            href="{{ route('admin.travel.details', $travel) }}"
                            class="group"
                        >
                                                ...
                                                <div class="w-full h-full flex items-center justify-center">
                                                    <div class="w-[500px] px-8 pt-8 pb-12 md:px-10 md:pt-10 md:pb-14 bg-white rounded-lg whitespace-normal text-left">
                                                        ...
                                                        <div class="mt-14 text-right space-x-2">
                                                            ...
                                                            <a 
                                                                href="#"
                                                                wire:click.prevent="delete({{ $travel }})"
